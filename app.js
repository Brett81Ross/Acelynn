...
finalReportBtn.addEventListener('click', () => {
    ...
    // Band 2 Punch Frequencies (80Hz - 250Hz)
    ...
    // Band 3 Mud & Boxiness (250Hz - 500Hz)
    ...
    // Band 4 Clarity & Presence (1kHz - 4kHz)
    ...
    // Band 5 Air & Sparkle (10kHz - 20kHz)
    if (airTicks / samplesCollectedCount > 0.3) {
        tableG5_new.textContent = "+1.5 dB (Wide Boost)";
